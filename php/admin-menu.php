 ...
 */
add_action('admin_menu', 'gmuw_miniorange_add_sublevel_menu');
function gmuw_miniorange_add_sublevel_menu() {
	
	// Add Wordpress admin menu item under settings for this plugin's settings
	add_submenu_page(
		'gmuw',
		'Mason MiniOrange Customizations',
		'Mason MiniOrange Customizations',
		'manage_options',
		'gmuw_miniorange',
		'gmuw_miniorange_display_settings_page',
		1
	);
